...
public class Add_Data_Activity extends AppCompatActivity {
    ...
    private void insertData() {
        ...
        if (name.isEmpty()) {
            ...
            progressDialog.show();
            StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.1.105/exam/insert.php",
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            if (response.equalsIgnoreCase("Data Inserted")) {
                                ...
                                startActivity(new Intent(getApplicationContext(), com.example.ps12919_phanvanvu_exam.MainActivity.class));
                                finish();
